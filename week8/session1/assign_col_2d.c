...
// prints the values of a column, with an appropriate message depending on option A or B (after/before)
...
// changes all values in specified array column to newValue
